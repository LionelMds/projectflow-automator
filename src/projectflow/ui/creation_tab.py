...
class CreationTab(QWidget):
    ...
    sync_repertoire_requested = Signal()
    ...
    def _build_ui(self) -> None:
        ...
        self.sync_repertoire_button = QPushButton("Synchroniser repertoire")
        ...
        self.sync_repertoire_button.clicked.connect(self.sync_repertoire_requested.emit)
        ...
        actions.addWidget(self.sync_repertoire_button)
